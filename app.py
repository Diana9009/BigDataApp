...
VERSION_APP = "Versión 2.2 del Junio 05 del 2025"
CREATOR_APP = "Diana Carolina Gomez Boada/ https://github.com/Diana9009/BigDataApp.git"
mongo_uri   = os.environ.get("MONGO_URI")

if not mongo_uri:
    #uri = "mongodb+srv://DbCentral:DbCentral2025@cluster0.vhltza7.mongodb.net/?appName=Cluster0"
    uri         = "mongodb+srv://dgomezb10:dgomezb10@cluster0.wfv03.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
    mongo_uri   = uri
...
client = Elasticsearch(
    "https://bigdataapp-eeeaea.es.us-east-1.aws.elastic.cloud:443",
    api_key="UDh5Qk9wY0J2VkozbUNWX2kzRVE6Y1ZGTGFMTDlXbE9kMDUxOHpTaDRVQQ=="
)
INDEX_NAME = "ucentral_diana"
...
def contacto():
    if request.method == 'POST':
        ...
        try:
            ...
            db = client['contactos']  # Nombre de la base de datos
            coleccion = db['mensajes_contacto']  # Nombre de la colección
            ...
            return render_template('contacto.html',
                                   error_message=f"Error al guardar el mensaje en MongoDB: {str(e)}",
                                   version=VERSION_APP,
                                   creador=CREATOR_APP)
        finally:
            if 'client' in locals():
...
def ver_contactos():
    try:
        ...
        db = client['contactos']
        coleccion = db['mensajes_contacto']

        mensajes = list(coleccion.find())
        ...
        return f"Error al obtener mensajes: {str(e)}"
    finally:
        if 'client' in locals():
            client.close()
...
def search():
    try:
        ...
        index_name = data.get('index', 'ucentral_diana')
